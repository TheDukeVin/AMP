...
if __name__ == "__main__":
    ...
    index, num_weighings = find_heavier_egg_nonrecursive(basket4)
    #index, num_weighings = find_heavier_egg_recursive(basket1)
    #type, index = find_lighter_or_heavier_egg(basket1)
    print(f"The fake egg has index of {index} in the basket")
    print(f"Number of weighings: {num_weighings}")
    #print(f"Type of fake egg: {type}")